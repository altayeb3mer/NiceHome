...
public class all_properties extends Fragment {
    ...
    public static ArrayList<String> pro_id,pro_country,pro_area,pro_bedrooms,pro_bathrooms,pro_space,pro_garages,pro_price,
            pro_images,type_en,pro_title;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString("area",pro_area.get(position) );
                    i.putExtras(bundle);
                    startActivity(i);
                }
            });
                    ...
                    public void onResponse(JSONArray response) {
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                String s_type_en = object.getString("type_en");
                                String s_title = object.getString("title");

                                if(s_type_en.equals("sale")){
                                    s_type_en=getResources().getString(R.string.sale);
                                }else if(s_type_en.equals("rent")){
                                    s_type_en=getResources().getString(R.string.rent);
                                }else if(s_type_en.equals("required")){
                                    s_type_en=getResources().getString(R.string.required);
                                }
                              ...
                              /*      switch (country){
                                        case "1":{
                                            area_array = getResources().getStringArray(R.array.area_array1);
                                            break;
                                        }
                                        case "2":{
                                            area_array = getResources().getStringArray(R.array.area_array2);
                                            break;
                                        }
                                        case "3":{
                                            area_array = getResources().getStringArray(R.array.area_array3);
                                            break;
                                        }
                                    }*/
                                    ...
                                    type_en.add(i,s_type_en.toString().trim());
                                    ...
                                    hideDialog();
                                    Toast.makeText(getActivity(),getResources().getString(R.string.sale_empty_dept), Toast.LENGTH_SHORT).show();
                                }
