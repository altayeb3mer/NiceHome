...
/**
 * Created by Altayeb on 11/9/2018.
 */
public class Other_properties_fragment extends Fragment {
    ...
    public Other_properties_fragment() {
    }
    //////////////////////////////////
    ...
    private void getPro() {
        if (URL.isNetworkConnected(getActivity())) {
            if (!URL.isInternetAvailable()) {
                ...
                params.put("category", section_arry_DB[9]);
